...
import styles from "./PopularDeliveryCss";
import { COLORS } from "../../../constants";
import PopularCard from "../poularcard/PopularCard";
import axios from "axios";

const PopularDelivery = ({ searchQuery }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get("https://fleet-deliveryapi.onrender.com/api/search", {
          params: {
            query: 'Delivery',
            num_pages: 1,
          },
