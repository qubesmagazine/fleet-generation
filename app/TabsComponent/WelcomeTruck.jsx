...
const data = [
  {
    title: "AD Top Rated",
    image: require("../../assets/images/topdelivery.webp"),
  },
  {
    title: "AD - Dispatch Truck",
    image: require("../../assets/images/truck2.jpeg"),
  },
  {
    title: "Ride Destinations",
    image: require("../../assets/images/truxk3.jpg"),
  },
  {
    title: "AD - Job Availability",
    image: require("../../assets/images/truck4.jpg"),
  },
  {
    title: "AD -Delivery Travelers",
    image: require("../../assets/images/cusomercare.png"),
  },
];

class WelcomeTruck extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activeIndex: 0,
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "lightgrey", // Background color of the AppIntroSlider
